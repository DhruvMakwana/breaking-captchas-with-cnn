...
#--dataset is the path to the input dataset of labeled captcha digits 
#(i.e., the dataset directory on disk)
ap.add_argument("-m", "--model", required=True,
	help="path to output model")
#--model is the path  to where our serialized LeNet weights will be 
...
#partition the data into training and testing with 75% data to training
#and 25% to testing 
